...
(OpenCode harness, Claude model family) generated initial implementations of
the \texttt{src/} and \texttt{cpp/} codec code, probe and experiment scripts,
the figure-generation script, and drafts of all paper sections, under human
direction. Humans defined every method, ran all verification (byte-asserted
round-trips, recomputed statistics, full test battery), and take full
